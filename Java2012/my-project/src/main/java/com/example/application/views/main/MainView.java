...
public class MainView extends AppLayout {
    ...
    private Component[] createMenuItems() {
        return new Tab[]{createTab("Hello World", HelloWorldView.class), createTab("About", AboutView.class),
                createTab("Person Form", PersonFormView.class), createTab("Dashboard", DashboardView.class),
                createTab("Card List", CardListView.class), createTab("List", ListView.class)};
    }
