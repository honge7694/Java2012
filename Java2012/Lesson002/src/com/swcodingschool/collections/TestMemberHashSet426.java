...
public class TestMemberHashSet426 {
	...
	public static void main(String[] args) {
		...
		Member m1 = new Member(1001, "고길동");
		Member m2 = new Member(1002, "김둘리");
		Member m3 = new Member(1003, "도우너");
		Member m4 = new Member(1004, "고희동");
		...
		Member m5 = new Member(1003, "마이콜"); // 생성이 안되야 정상 Member 427[S] ~ [E] 있어야 작동.
		hash.addMember(m5);
		hash.showAllMember();
